...
# -----------------------------
data = {
    "음식": ["사과", "바나나", "딸기", "우유", "요거트", "치즈", "계란", "피자", "라면", "밥"],
    "칼로리": [52, 89, 33, 42, 59, 402, 155, 266, 450, 130],
    "단백질": [0.3, 1.1, 0.8, 3.4, 10, 25, 13, 11, 10, 2.7],
    "탄수화물": [14, 23, 8, 5, 3.6, 1.3, 1.1, 33, 70, 28],
    "지방": [0.2, 0.3, 0.3, 1, 0.4, 33, 11, 10, 16, 1]
}
